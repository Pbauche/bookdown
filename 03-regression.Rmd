...
---
# Regression
```{r reg library, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r reg lin, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r multinormal, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r model selec step, echo=TRUE, message=FALSE, warning=FALSE}
### Data prep ###
#################
...
```{r lasso, echo=TRUE, message=FALSE, warning=FALSE}
library("glmnet")
